...
import Program_Resource from './pages/Program_Resource';
import Mentor_Profile_Home from './pages/Mentor_Profile_Home';
import All_Categories from './pages/All_Categories';
import Course_And_Mentor from './pages/Course_And_Mentor';
import Faq from './pages/Faq';
import SessionTimeout from './components/SessionTimeout';
import GlobalModalCleanup from './components/GlobalModalCleanup';
    ...
    <Router>
      <SidebarProvider>
        ...
        <Routes>
          ...
          <Route path='/program-resource/:id' element={<Program_Resource />} />
          <Route path='/mentor-profile-home/:id' element={<Mentor_Profile_Home />} />
          <Route path='/all-categories' element={<All_Categories />} />
          <Route path='/course-and-mentor' element={<Course_And_Mentor />} />
