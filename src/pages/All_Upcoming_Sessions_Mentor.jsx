...
const All_Upcoming_Sessions_Mentor = () => {
...
const toggleMenu = (id, e) => {
  ...
  const fetchUpcomingSessions = async () => {
    try {
      ...
      const res = await api.get(`/session/upcoming/${id}?type=mentor`);
                  ...
                  {activeMenu === session.id && (
                    ...
                    >
                      <div
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          navigate("/resheduled-for-mentors", { state: { sessionId: session.id,mentorId: session.mentorId,localDate: session.localDate } });
                          setActiveMenu(null);
          ...
          <div className="LoginBody">
            ...
            <article>
              ...
              <button onClick={(e) => {
                e.stopPropagation();
                window.$('#SessionsModal').modal('hide');
                navigate(`/chat-with-mentee/${selectedSession.menteeId}`, {
                  state: {
                    mentorName: selectedSession.mentee?.fullname,
                  }
                });
              }}>Start Chat</button>
              <button
              onClick={(e) => {
                e.stopPropagation();
                window.$('#SessionsModal').modal('hide');
                navigate("/resheduled-for-mentors", {
                  state: {
...
export default All_Upcoming_Sessions_Mentor
