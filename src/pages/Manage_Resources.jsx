      ...
      <div className="WrapperArea">
        <div className="WrapperBox">
          ...
          <div className="HistoryBody">
            <div className="row">
              {resources.length === 0 && (
                <p style={{ padding: '0 15px', minHeight: '150px' }}>No resources found</p>
              )}
              {resources.map((item) => (
          ...
          <div className="HistoryBody">
            ...
            <div className="row">
              {videos.length === 0 && (
                <p style={{ padding: '0 15px', minHeight: '150px' }}>No videos found</p>
              )}
        ...
        <div className={`modal fade newclass ${showEditModal ? "show d-block" : ""}`} id="ResourcesModal">
        ...
        <div className={`modal fade newclass ${showEditVideoModal ? "show d-block" : ""}`} id="VideoModal">
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="LoginBox Resources NewLoginBox">
                <div className="LoginHead">
