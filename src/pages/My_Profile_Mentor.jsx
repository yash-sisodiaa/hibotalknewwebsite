...
const My_Profile_Mentor = () => {
  ...
  useEffect(() => {
    ...
    window.$('#MenteeModal').on('hidden.bs.modal', handleModalHidden);

    return () => {
      window.$('#MenteeModal').off('hidden.bs.modal', handleModalHidden);
    };
  }, []);
    ...
    try {
      ...
      if (res.data.success) {
        ...
        setTimeout(() => {
          ...
          // Force all modals to be display none and aria-hidden false
          ...
          <div className="MontorArea">
            <div className="MontorName align-items-center">
              ...
              <figure style={{ position: 'relative' }}>
                <img src={profile?.profile_pic || "/images/person-icon-png-12.jpg"} alt="Profile" />
                ...
                <div className="row">
                  ...
                  <div className="col-sm-12">
                    <div className="form-group d-flex flex-column align-items-center">
                      <label style={{ textAlign: 'center' }}>Looking to improve</label>

                      <details style={{ position: 'relative', width: '100%', maxWidth: '350px' }}>
                        <summary
                          className="form-control"
                          style={{
                            cursor: 'pointer',
                        ...
                        >
                          {specializations.map(item => {
                            ...
                            return (
                              <div className="form-check" key={item.id} style={{ textAlign: 'left' }}>
                                <input
                                  className="form-check-input"
                                  type="checkbox"
                                  checked={selectedIds.includes(item.id)}
