...
const All_Mentors = () => {
  ...
  const filteredMentors = mentors.filter((mentor) => {
    ...
    return (
      ...
      mentor.specializations?.toLowerCase().includes(term) ||
  ...
  try {
    ...
    fetchMentors(); // Refresh the mentors list after toggling wishlist
  } catch (error) {
                ...
                <>
                  ...
                  <div className="form-check">
                    <input
                      ...
                      onChange={(e) => setSelectedSort(e.target.value)}
                    />
                    <label className="form-check-label" htmlFor="sort-recent">
                      Most Recents
                    </label>
                  </div>
                </>
                ...
                <div className="MontorBox">
                                    ...
                                    <i
                                      onClick={(e) => {
                                       ...
                                       className={`fa ${
                                            mentor.isLiked ? "fa-heart text-danger" : "fa-heart-o"
                                        }`}
                                        aria-hidden="true"
                                    ></i>
                                  </span>
