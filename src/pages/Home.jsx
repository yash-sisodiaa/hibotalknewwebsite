...
const Home = () => {
  ...
  useEffect(() => {
    if (mentors.length > 0) {
      ...
      setTimeout(() => {
        if ($('#InspiresSlider').length) {
          // Destroy if already exists
          if ($('#InspiresSlider').hasClass('owl-carousel')) {
            $('#InspiresSlider').trigger('destroy.owl.carousel');
          }
    ...
    <section>
        <div className="FilterArea">
            <div className="FilterBox">
                ...
                <input type="text" placeholder="Search for courses, mentors or skills…"/>

                <div className="dropdown">
                     <Link href="javascript:void(0)" id="navbardrop" className="dropdown-toggle" data-toggle="dropdown"
                        aria-expanded="false">
      ...
      <div className="ProgramBody">
        <div id="demos">
          <div className="owl-carousel owl-theme" id="ProgramSlider" key={activeIndex}>
            {data[activeIndex].resources.map((res) => (
              <div className="item" key={res.id}>
                <div className="ProgramBox">
                  ...
                  <figcaption>
                    <h6>
                      {res.totalViews} students <span>1h 42m</span>
                    </h6>
                    <h5>
                      <Link to="program-details.html">{res.heading}</Link>
                    </h5>
  ...
  <div className="InspiresArea">
    <div className="container-fluid">
      ...
      <div className="InspiresBody">
        <div id="demos">
          <div className="owl-carousel owl-theme" id="InspiresSlider">
            {mentors.map((item) => {
                ...
                <div className="item" key={item.mentor.id}>
                  <div className="InspiresBox">
                    ...
                    <figcaption>
                      ...
                      <h3>
                        <Link href="mentor-profile.html">{item.mentor.fullname}</Link>
                      </h3>
