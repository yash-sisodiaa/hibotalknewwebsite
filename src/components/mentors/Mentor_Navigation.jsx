  ...
  return (
    <div className="Navigation">
      ...
      <ul>
        <li>
          <a
            onClick={() => navigate("/all-chats-mentor")}
            className="Circle"
        ...
        <li className={`dropdown profile ${showProfile ? "show" : ""}`}>
          ...
          <ol className={`dropdown-menu ${showProfile ? "show" : ""}`}>
            <li>
              <a onClick={() => navigate("/my-profile-mentor")} style={{ cursor: "pointer" }}>
                <span className="Icon">
            ...
            <li>
              <a onClick={() => navigate("/help-center")} style={{ cursor: "pointer" }}>
                <span className="Icon">
...
export default Mentor_Navigation
