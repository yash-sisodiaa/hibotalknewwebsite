    ...
    <>
      <div className="HistoryArea">
        <div className="HistoryHead">
          <h3>Upcoming Sessions <Link to="/all-upcoming-sessions-mentor">View all</Link></h3>
        </div>
          ...
          <div className="row">
            ...
            {sessions.length > 0 ? (
              ...
              <div className="col-12">
                <p style={{ minHeight: '120px' }}>No upcoming sessions found.</p>
              </div>
            )}
...
export default Upcoming_Mentor_Session
